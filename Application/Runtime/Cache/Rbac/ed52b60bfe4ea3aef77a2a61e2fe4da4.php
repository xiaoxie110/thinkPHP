...
<!-- 主体内容  -->
<div class="content" >
<div class="title"> 应用授权 [ <a href="/thinkPHP/Rbac/Role">返回</a> ]</div>
<!--  功能组区域  -->
<script language="JavaScript">
<!--
function saveAccess(){
ThinkAjax.sendForm('form1','/thinkPHP/Rbac/Role/setApp/');
}
//-->
</script>
<div id="result" class="result none"></div>
<script type="text/javascript" src="/thinkPHP/Public/Js/Form/MultiSelect.js"></script>
<form method=post id="form1">
<table class="select" style="width:265px" align="center">
<tr><td height="3" colspan="3" class="topTd" ></td></tr>
<tr><th class="tCenter">应用授权 | <a href="/thinkPHP/Rbac/Role/module/groupId/<?php echo ($_GET['groupId']); ?>">模块授权</a> | <a href="/thinkPHP/Rbac/Role/action/groupId/<?php echo ($_GET['groupId']); ?>">操作授权</a>
</th></tr>
