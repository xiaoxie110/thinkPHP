...
<div class="content">
<div class="title">添加数据 [ <a href="/thinkPHP/Rbac/Form">返回列表</a> ]</div>
...
<form method='post' id="form1" name="form1" action="/thinkPHP/Rbac/Form/insert"  enctype="multipart/form-data">
