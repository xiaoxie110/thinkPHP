...
<!-- 主体内容  -->
<div class="content" >
<div class="title"><?php if(isset($nodeName)): ?>[<?php echo ($nodeName); ?>]<?php endif; if(($level) == "1"): ?>应用<?php endif; if(($level) == "2"): ?>模块<?php endif; if(($level) == "3"): ?>操作<?php endif; ?>列表 <span style="font-weight:normal">[ 分组:&nbsp;<?php if(is_array($groupList)): $i = 0; $__LIST__ = $groupList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tag): $mod = ($i % 2 );++$i;?><a href="/thinkPHP/Rbac/Node/index/group_id/<?php echo ($key); ?>"><?php echo ($tag); ?></a>&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?><a href="/thinkPHP/Rbac/Node">所有</a> ] </span></div>
<!--  功能操作区域  -->
<div class="operate" >
...
<!-- 查询区域 -->
<div class="fRig">
<form method='post' action="/thinkPHP/Rbac/Node">
