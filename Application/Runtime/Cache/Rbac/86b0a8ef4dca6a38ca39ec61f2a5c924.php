...
<div class="content">
<div class="title"> 分组排序  [ <a href="/thinkPHP/Rbac/Group">返回列表</a> ]</div>
<script language="JavaScript">
<!--
function saveSort(){
sl.ok();
ThinkAjax.sendForm('form1','/thinkPHP/Rbac/Group/saveSort/','result');
}
//-->
</script>
<div id="result" class="result none"></div>
<script type="text/javascript" src="/thinkPHP/Public/Js/Form/SortSelect.js"></script>
