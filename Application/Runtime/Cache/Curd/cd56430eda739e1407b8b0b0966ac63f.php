...
<html>
 ...
 <!--
	function add(){
		window.location.href="/thinkphp/index.php/Curd/Index/add";
	}
	function edit(id){
		window.location.href="/thinkphp/index.php/Curd/Index/edit/id/"+id;
	}
	function del(id){
		window.location.href="/thinkphp/index.php/Curd/Index/delete/id/"+id;
	}
 //-->
 </script>
 <div class="main">
